    ...
    <div>
      ...
      <div className="my-10 flex flex-col md:flex-row gap-16">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-gray-600">
          <p>
            Forever was born out of a passion for innovation and a desire to revolution the way people shop online. Our
          ...
          <p>
            Our mission at forever is to empower customers with choice, convenience, and confidence. We've dedicated to
      ...
      <div className="flex flex-col md:flex-row text-sm mb-20">
        ...
        <div className="border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
          ...
          <p classname="text-gray-600">
            Our team of professionals is here to assist you the way, ensuring your satisfaction is our top priority
          </p>
        </div>
      </div>
